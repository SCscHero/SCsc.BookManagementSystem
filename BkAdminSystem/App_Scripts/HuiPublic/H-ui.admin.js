...
//    var pid=new Array();
//    $('.productId:checked').each(function(index){
//        pid[index]=$(this).val();
//    })
//    var zs = pid.length;
//    if(pid.length>0){
//        layer.confirm('尊敬的'+user+'用户，您已提交的'+zs+'条游学产品信息将批量上架，确认上架？', {
//            btn: ['取消','确定'],
//            btn2:function(){
//                $.ajax({
//                    type: 'POST',
//                    url: '{:U("updateStatusUpDown")}',
//                    data:{pid:pid ,'status':44},
//                    dataType: 'json',
//                    beforeSend:function(){
//                        layer.load(2, {

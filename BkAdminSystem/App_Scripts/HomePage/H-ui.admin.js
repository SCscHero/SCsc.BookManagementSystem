...
function getskincookie(){
	...
	if(hrefStr!=undefined){
		var hrefRes=hrefStr.substring(0,hrefStr.lastIndexOf('default'))+v+'/skin.css';
...
$(function(){
	...
	$("#Hui-skin .dropDown-menu a").click(function(){
		var v = $(this).attr("data-val");//【Hero】attr语句用来获取data-val属性所对应的值
		$.cookie("Huiskin", v);//【Hero】创建一个名为Huiskin的cookie 值为皮肤名
		var hrefStr = $("#skin").attr("href");//【Hero】获取id为skin的css文件的路径
	    /*
            【Hero】将其他皮肤的路径赋给hrefRes变量
            【Hero】JS中substring方法，作用截取字符串，参数有二，开始字符处，截至字符处
            【Hero】JS中lastIndexOf方法：作用设定指定字符串之前的字符个数
        */
		var hrefRes = hrefStr.substring(0, hrefStr.lastIndexOf('Skin/')) + 'Skin/' + v + '/skin.css';
	    //通过框架文件找到id为skin的css文件，改变href属性为hrefRes的值，从而改变皮肤
